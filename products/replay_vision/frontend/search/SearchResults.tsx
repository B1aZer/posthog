...
function SubjectLabel({ observation }: { observation: ReplayObservationApi }): JSX.Element {
    ...
    // Only a distinct id resolves to a person page.
...
/** The ranked response, paged. Nothing renders until a search has found something. */
export function SearchResults({
    ...
    // The split runs over the whole response, so a page that starts inside the second tier opens with that heading.
    return (
